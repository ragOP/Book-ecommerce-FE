    ...
    appendProduct = function ($pObj) {
        ...
        btnOrder.each(function (index, item) {
                ...
                if (item.api_type == "stripe") {
                  ...
                  <div id="${item.api_type + "_block_" + index
                      ...
                      <div class="text-center mt-3">
                        ...
                        }"  type="button" class="d-none btn btn-success btn-lg ft-payment-stripe w-100 mt-3">Complete Order <i class="fas fa-arrow-circle-right"></i></button>
                      </div>
                  </div>`;
            ...
            var pay_layout = `<div class="ftpaycomplete-box text-left ft-skelecton">
                        <div class="ftpaycomplete-inner ${ftpaycomplete_inner}">
                        ...
                        <div class="ftpaycomplete-button">
                            <button type="button" class="btn btn-success btn-lg ft-payment-orderButton w-100 mt-3">Complete Order <i class="fas fa-arrow-circle-right"></i></button>
                        </div>
                        ${terms}
                  </div>`;
